    ...
    return ( 
        <div className="form-signs">
            ...
            <label className="form-control w-full max-w-xs">
                ...
                <input type="text" placeholder="البريد الإلكتروني" className="input input-bordered w-[90%] m-auto max-w-xs avenir-book" />
            </label>
            <label className="form-control w-full max-w-xs">
                <div className="label avenir-heavy">
                    <span className="input-signin">كلمة المرور</span>
                </div>
                <input type="text" placeholder="كلمة المرور" className="input input-bordered w-[90%] m-auto max-w-xs avenir-book" />
            </label>
