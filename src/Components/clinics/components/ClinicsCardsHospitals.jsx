...
// Import your images
import dammam_img from "../../hospitals/assets/imgs/dammam.webp";
import gadah_img from '../../hospitals/assets/imgs/gadah.jpg';
import madina_img from '../../hospitals/assets/imgs/madina.jpg';
import mekka_img from '../../hospitals/assets/imgs/mekka.jpg';
import riyadh_img from '../../hospitals/assets/imgs/riyadh.jpg';

// Install Swiper modules
SwiperCore.use([Navigation, Pagination]);

export default function ClinicsCardsHospitals() {
  return (
    <div className='my-10 mx-auto'>
       <div className='cards-flex cards-hospital p-4'>
        ...
        >
          {[riyadh_img, gadah_img, dammam_img, mekka_img, madina_img].map((img, index) => (
